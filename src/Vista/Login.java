...
public class Login extends javax.swing.JFrame {
    public Login() {
        initComponents();
        String path = System.getProperty("user.dir") + "\\src\\Imagenes\\Logo.png";
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        String usuarioL = "admin";
        String contrasenaL = "S0p0rt3";
        
        if (usuario.equals(usuarioL) && contrasena.equals(contrasenaL)) {
